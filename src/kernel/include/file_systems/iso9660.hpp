...
int iso9660_read_file(fs_t*, drive_t* drive, const char* file_path, void** file_data, size_t* size);
int iso9660_write_file(fs_t*, drive_t* drive, const char* file_path, void* file_data, size_t* size);
