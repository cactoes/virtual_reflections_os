...
enum class vga_gm_color_index_t : u8 {
    BLACK =       0,
    BLUE =        1,
    GREEN =       2,
    CYAN =        3,
...
namespace vga_gm_draw {
    ...
    bool lineh(vga_buffer_t* p_back_buffer, u64 x, u64 y, size_t len, vga_gm_color_index_t color_index);
    bool linev(vga_buffer_t* p_back_buffer, u64 x, u64 y, size_t len, vga_gm_color_index_t color_index);
    bool square(vga_buffer_t* p_back_buffer, u64 x, u64 y, size_t w, size_t h, vga_gm_color_index_t color_index);
    bool move_square(vga_buffer_t* p_back_buffer, u64 x, u64 y, size_t w, size_t h, size_t nx, size_t ny);
