...
u64 ahci_get_sector_size(ahci_device_t* device) {
    return device->logical_sector_size;
}

u64 ahci_get_capacity(ahci_device_t* device) {
    return device->capacity;
}

const disk_interface_t* get_ahci_disk_interface() {
    static const disk_interface_t interface {
        .read = (decltype(disk_interface_t::read))ahci_read,
        .write = nullptr,
        .get_sector_size = (decltype(disk_interface_t::get_sector_size))ahci_get_sector_size,
        .get_capacity = (decltype(disk_interface_t::get_capacity))ahci_get_capacity,
        .get_model = [](void* disk_data) -> const char* { return ((ahci_device_t*)disk_data)->meta.model; },
        .get_serial = [](void* disk_data) -> const char* { return ((ahci_device_t*)disk_data)->meta.serial; },
        .get_firmware = [](void* disk_data) -> const char* { return ((ahci_device_t*)disk_data)->meta.firmware; }
    };
